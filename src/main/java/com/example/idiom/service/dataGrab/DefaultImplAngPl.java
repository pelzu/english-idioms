...
public class DefaultImplAngPl implements DataGrabberAngPl<String> {
    @Override
    public List<String> getObject(String kind, String audio, String csv) {
        List<String > stringList =
                Arrays.asList(
                        "Are you trying get kind:"+kind+ " try write phrasal or idiom",
        ...
        log.warn("Wrong param    "+" kind:"+kind+" audio:"+audio+" csv:"+csv);
        return stringList;
    }
}
